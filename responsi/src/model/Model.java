...
public class Model {
    ...
    public String[][] readMovie(){
        try{
            ...
            String data[][] = new String[getData()][5]; //baris, kolom nya ada 5
    ...
    public void insertData(String judul, String alur, String penokohan, String akting, String nilai){
        int jmlData=0;
        try {
           ...
           while (resultSet.next()){ 
            ...
            if (jmlData==0) {
                ...
                double nilai1 = (alur1+penokohan1+akting1)/3.0;
                
                nilai=String.valueOf(nilai1);
    ...
    public void updateData(String judul, String alur, String penokohan, String akting, String nilai){
        int jmlData=0;
         try {
           String query = "Select * from movie WHERE judul='"+judul+"'"; 
           ResultSet resultSet = statement.executeQuery(query);
